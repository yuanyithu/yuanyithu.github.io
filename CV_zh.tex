...
\begin{center}
    {\LARGE\bfseries 袁逸}\quad {\Large Yi Yuan}\\[0.3em]
    {\small
...
\entry{清华大学 \enspace 物理学学士，基础科学实验班（数理方向）}{2019.08 -- 2023.06}
...
\begin{itemize}
    ...
    \item \textbf{AI/机器学习：} 熟悉 Transformer 架构；熟练使用 JAX 和 PyTorch；具有 CNN 建模经验
...
\noindent{\small 工作经历：2023.08--2025.01 清华大学物理系学生辅导员 \quad 2024--2025 优秀学生干部}
