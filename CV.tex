...
\entry{Tsinghua University \enspace B.S. in Fundamental Sciences, Mathematics and Physics}{2019.08 -- 2023.06}
...
\begin{itemize}
    ...
    \item \textbf{AI/ML:} Familiar with Transformer architectures and RLHF workflows (PPO/GRPO); experienced with JAX and PyTorch; hands-on experience in CNN modeling and LLM API application development
...
\noindent{\small Leadership: 2023.08--2025.01 Student Counselor, Department of Physics, Tsinghua University \quad 2019--2020 Youth League Branch Secretary (branch rated ``Class A'') \quad 2024--2025 Outstanding Student Leader}
