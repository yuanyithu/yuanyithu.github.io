(function () {
  const translations = {
    en: {
      ...
      highlightUndergraduate: "B.S. in Physics, Fundamental Science Experimental Class (Mathematics and Physics), Tsinghua University, 2019–2023",
    ...
    zh: {
      ...
      highlightUndergraduate: "清华大学物理学学士，基础科学实验班（数理方向），2019–2023",
      interestTitle: "兴趣",
